...
object TelecomStorage {
    ...
    private val samsungContainer: MutableList<SamgsungGalaxy> = mutableListOf(
        ...
        SamgsungGalaxy("Galaxy S24", 1000, "010-1234-5678", "1234"),
    ...
    fun removeIPhone(iPhone: AppleIPhone) {
        iPhoneContainer.remove(iPhone)
    }

    fun removeGalaxy(galaxy: SamgsungGalaxy) {
        samsungContainer.remove(galaxy)
    }
}
